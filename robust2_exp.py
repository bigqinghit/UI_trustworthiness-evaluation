...
def shelter(impath, mianji):
    ...
    h = img2.height  # 图片的高
    print(w, h)
    num_w = random.sample(range(int(int(mianji*w*h) / 256) + 3, min(int(mianji*w*h) // 2,253)), 1)
    print(num_w)
    print(h - int(int(mianji*w*h) // num_w[0]))
